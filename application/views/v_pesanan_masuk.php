    ...
    <div class="card card-dark card-outline card-outline-tabs">
        <div class="card-header p-0 border-bottom-0">
            <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active text-dark" id="1" data-toggle="pill" href="#semua_pesanan" role="tab" aria-controls="custom-tabs-four-home" aria-selected="true">Pesanan Masuk</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link text-dark" id="4" data-toggle="pill" href="#selesai_pesanan" role="tab" aria-controls="custom-tabs-four-settings" aria-selected="false">Selesai</a>
                </li>
            </ul>
        </div>
        <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php if ($value->status_bayar == 1) { ?>
                                        <button class="btn btn-sm btn-secondary mb-2" data-toggle="modal" data-target="#cek<?= $value->id_transaksi ?>"><i class="fa fa-money-check mr-1"></i> Cek Bukti Bayar</button><br>
                                        <a href="<?= base_url('admin/proses/' . $value->id_transaksi) ?>" class="btn btn-sm btn-flat rounded btn-dark"><i class="fa fa-check mr-1"></i> Verifikasi</a>
                    ...
                    <table class="table">
                        ...
                        <?php foreach ($pesanan_diproses as $key => $value) { ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php if ($value->status_bayar == 1) { ?>
                                        <button class="btn btn-sm btn-flat rounded btn-dark" data-toggle="modal" data-target="#kirim<?= $value->id_transaksi ?>"><i class="fa fa-truck mr-1"></i> Kirim</button>
                                    <?php } ?>
                                </td>
                            </tr>
                        <?php } ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table class="table">
                        <tr>
                            <th>Expedisi</th>
                            <th>=</th>
                            <td style="text-transform:uppercase"><?= $value->expedisi ?></td>
                        </tr>
                        <tr>
                            <th>Paket</th>
                            <th>=</th>
                        ...
                        <tr>
                            <th>Ongkir</th>
                            <th>=</th>
                            <td><?= number_format($value->ongkir, 0) ?></td>
                        </tr>
                        <tr>
                            <th>No Resi</th>
                            <th>=</th>
                            <td><input name="no_resi" class="form-control" required placeholder="No Resi"></td>
                        </tr>
                    </table>
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button type="submit" class="btn btn-dark"><i class="fa fa-truck mr-1"></i> Kirim</button>
                </div>
                <?php echo form_close() ?>
            </div>
            <!-- /.modal-content -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <a href="<?= base_url('admin/delete_pesanan/'.$value->id_transaksi) ?>"
