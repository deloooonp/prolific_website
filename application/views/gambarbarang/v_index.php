            ...
            <table class="table table-bordered" id="example1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center"><span class="badge bg-dark"><h5><?= $value->total_gambar ?></h5></span></td>
                        <td class="text-center"> 
                            <a href="<?= base_url('gambarbarang/add/'.$value->id_barang) ?>" class="btn btn-dark btn-sm"><i class="fas fa-plus mr-1"></i>Add Gambar</a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
