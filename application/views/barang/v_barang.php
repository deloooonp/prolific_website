    ...
    <div class="card card-dark">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="<?= base_url('barang/add') ?>" type="button" class="btn btn-secondary btn-sm"><i class="fas fa-plus mr-2"></i>Add</a>
            </div>
            <!-- /.card-tools -->
        </div>
        <!-- /.card-header -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h5>Apakah anda yakin ingin menghapus barang ini?</h5>
            </div>
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <a href="<?= base_url('barang/delete/' . $value->id_barang) ?>"  class="btn btn-dark">Delete</a>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
