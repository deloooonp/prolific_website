        ...
        <div class="register-box">
            <div class="card">
                <div class="card-body register-card-body">
                    <p class="login-box-msg text-dark font-weight-bold">Register Pelanggan Baru</p>
                    <?php
                    ...
                    <?php echo form_close() ?>
                    <a href="<?= base_url('pelanggan/login') ?>" class="text-center text-dark">Saya Sudah Punya Akun</a>
                </div>
                <!-- /.form-box -->
            </div>
        </div>
